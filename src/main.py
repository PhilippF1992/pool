...
client.publish("homeassistant/switch/pool/cover_closed/config",json.dumps(closed_conf), 0, True)
...
while True:
    ...
    client.publish("homeassistant/switch/pool/cover_closed/state",str(cover_closed), 0, False)
    time.sleep(6)
